  ...
  */
  ...
  /*---------- 01. On Load Function ----------*/
    ...
    $(".global-carousel").each(function () {
        ...
        var slideCount = carouselSlide.find('.hero-slider').length;
        ...
        // Disable slider if there's only one slide
        if (slideCount <= 1) {
            carouselSlide.slick({
                dots: false,
                arrows: false,
            ...
            // If more than 1 slide, initialize slider with full functionality
            carouselSlide.slick({
